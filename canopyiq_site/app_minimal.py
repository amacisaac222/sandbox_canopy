"""
Minimal CanopyIQ application for Cloud Run deployment
This version starts quickly without database dependencies
"""
...
@app.get("/health")
async def health():
    return {"ok": True, "service": "canopyiq", "version": "minimal", "status": "healthy"}
...
def page(request: Request, *, title: str, desc: str, path: str, **ctx):
    ...
    return templates.TemplateResponse(path, {
        ...
        "asset_ver": "2025-08-26-minimal",
        "user": None,  # No authentication in minimal version
        **ctx
    })
...
async def login(request: Request):
    ...
    <p>Full authentication system is being deployed. Please check back in a few minutes.</p>
...
async def startup_event():
    ...
    logger.info("Starting CanopyIQ minimal application")
    ...
    logger.info("CanopyIQ minimal startup completed successfully")
